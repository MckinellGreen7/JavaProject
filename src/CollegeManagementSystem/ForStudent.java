...
public class ForStudent extends javax.swing.JFrame {

    /**
     * Creates new form ForStudent
     */
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(785, 556));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        setVisible(false);
        StudentTeacher object = new StudentTeacher();
        object.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ForStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ForStudent().setVisible(true);
            }
        });
    }
